// ============================================================
// THE-Bridge DRS - Dynamic Rebate System
...
contract DynamicRebateSystem {
    IERC20 public immutable drmToken;

    uint256 public constant REBATE_POOL_PCT = 35; // 35% of fees → rebates
    uint256 public constant TIER_1_THRESHOLD = 10_000 * 10**18;  // 10K DRM staked
    uint256 public constant TIER_2_THRESHOLD = 50_000 * 10**18;  // 50K DRM
    uint256 public constant TIER_3_THRESHOLD = 250_000 * 10**18; // 250K DRM
    ...
    constructor(address _drmToken) {
        drmToken = IERC20(_drmToken);
    }
    ...
    function claimRebate() external {
        ...
        require(drmToken.transfer(msg.sender, amount), "DRS: transfer failed");

        emit RebateClaimed(msg.sender, amount, tier);
    }

    function stake(uint256 amount) external {
        require(drmToken.transferFrom(msg.sender, address(this), amount), "DRS: stake failed");
    ...
    function unstake(uint256 amount) external {
        ...
        staked[msg.sender] -= amount;
        require(drmToken.transfer(msg.sender, amount), "DRS: unstake failed");
    }
