// ============================================================
// SwiftBridge Unilateral Recovery v2
...
contract UnilateralRecovery {
    ...
    constructor(address _swbToken, address _dao, address _sgxVerifier, address _teeEnclave) {
        swbToken = _swbToken;
        dao = _dao;
    ...
    function executeRecovery(address user) external {
        ...
        require(IERC20(swbToken).transfer(user, actualAmount), "UR: transfer failed");
    ...
    function teeEmergencyWithdraw(
        ...
        require(IERC20(swbToken).transfer(user, amount), "UR: transfer failed");
