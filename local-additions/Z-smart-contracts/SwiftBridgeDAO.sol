// ============================================================
// SwiftBridge DAO - Decentralized Autonomous Organization
...
contract SwiftBridgeDAO {
    using ECDSA for bytes32;

    // ==================== State ====================
    address public immutable swbToken;
    uint256 public constant MIN_VOTING_POWER = 1000 * 10**18; // 1000 SWB to vote
    uint256 public constant VOTING_PERIOD = 7 days;
    uint256 public constant EXECUTION_DELAY = 2 days;
    uint256 public constant QUORUM = 4_000_000 * 10**18; // 4M SWB quorum
    ...
    constructor(address _swbToken, address _teeEnclave) {
        swbToken = _swbToken;
    ...
    function propose(ProposalType pType, string calldata description, bytes calldata data) external returns (uint256) {
        ...
        require(ERC20(swbToken).balanceOf(msg.sender) >= MIN_VOTING_POWER, "DAO: insufficient voting power");
    ...
    function castVote(uint256 proposalId, bool support) external {
        ...
        uint256 weight = ERC20(swbToken).balanceOf(msg.sender);
    ...
    function emergencyHalt() external {
        require(
            msg.sender == teeEnclave || ERC20(swbToken).balanceOf(msg.sender) >= 10_000_000 * 10**18,
            "DAO: unauthorized"
        );
        halted = true;
